  ...
  return (
    <section className="flex flex-col rounded-lg border border-primary/30 bg-background">
      ...
      <div className="grid gap-3 p-3 lg:grid-cols-[minmax(0,_1.1fr)_minmax(0,_0.9fr)]">
        ...
        <div className="sticky top-0 z-10 max-h-[30vh] overflow-auto rounded-md border border-border bg-muted p-3 font-mono text-[11px] leading-[1.6] shadow-md sm:text-[12px] lg:max-h-[calc(100dvh-12rem)] lg:bg-muted/30 lg:text-[13px] lg:leading-[1.7] lg:shadow-none">
